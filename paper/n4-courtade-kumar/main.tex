...
withdrawn~\cite{Kesal15,Sarbu16}. Courtade and Kumar~\cite{CK14} enumerated
compressed Boolean functions through $n=7$ and sampled the noise parameter on
a grid of spacing $0.001$, but this is not a continuum proof. We are not aware of a proof covering
